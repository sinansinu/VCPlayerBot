...
async def start(client, message):
    buttons = [
        [
            InlineKeyboardButton('⚙️ Update Channel', url='https://t.me/LXRYOUTUBERYT'),
            InlineKeyboardButton('🧩 Source', url='https://github.com/LXR-YOUTUBER-AMAL/VCPlayerBot')
        ],
        [
...
async def repo_(client, message):
    buttons = [
        [
            InlineKeyboardButton('🧩 Repository', url='https://github.com/LXR-YOUTUBER-AMAL/VCPlayerBot'),
            InlineKeyboardButton('⚙️ Update Channel', url='https://t.me/LXRYOUTUBEYT'),
            
        ],
    ]
    await message.reply("<b>The source code of this bot is public and can be found at <a href=https://github.com/LXR-YOUTUBER-AMAL/VCPlayerBot>VCPlayerBot.</a>\nYou can deploy your own bot and use in your group.\n\nFeel free to star☀️ the repo if you liked it 🙃.</b>", reply_markup=InlineKeyboardMarkup(buttons))
