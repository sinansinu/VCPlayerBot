...
async def notforu(_, m: Message):
    await _.send_cached_media(chat_id=m.chat.id, file_id="CAADBQADEgQAAtMJyFVJOe6-VqYVzAI", caption="You Are Not Authorized", reply_markup=InlineKeyboardMarkup([[InlineKeyboardButton('⚡️Join Here', url='https://t.me/LXRYOUTUBEYT')]]))
...
async def not_chat(_, m: Message):
    buttons = [
        [
            InlineKeyboardButton('⚡️Make Own Bot', url='https://github.com/LXR-YOUTUBER-AMAL/VCPlayerBot'),
            InlineKeyboardButton('🧩 Join Here', url='https://t.me/LXRYOUTUBEYT'),
        ]
        ]
    await m.reply("<b>You can't use this bot in this group, for that you have to make your own bot from the [SOURCE CODE](https://github.com/LXR-YOUTUBER-AMAL/VCPlayerBot) below.</b>", disable_web_page_preview=True, reply_markup=InlineKeyboardMarkup(buttons))
